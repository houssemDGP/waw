...
import BackOfficeVendeurRestaurants from "./pages/Tables/BackOfficeVendeurRestaurants";
import BackOfficeAdminRestaurants from "./pages/Tables/BackOfficeAdminRestaurants";
...
import RestaurantEditPage from "./components/RestaurantEditPage";
import AddRestaurantPage from "./pages/AddRestaurantPage";
import RestaurantTablesPage from "./pages/RestaurantTablesPage";
import RestaurantsListPage from "./pages/RestaurantsListPage";
import RestaurantPlacesPage from "./pages/RestaurantPlacesPage";
 
import RestaurantDetailsPage from "./pages/RestaurantDetailsPage";

import RestaurantReservation from "./pages/RestaurantReservation";

import RestaurantReservationAdmin from "./pages/RestaurantReservationAdmin";



import PaymentPagesuccess from "./pages/PaymentPagesuccess";
import PaymentPagefailed from "./pages/PaymentPagefailed";
        ...
        <Routes>
          ...
          <Route element={<AppLayoutAdmin />}>
            ...
            <Route path="/admin/bussiness" element={<BusnissList />} />
                        ...
                        <Route path="/admin/restaurants" element={<BackOfficeAdminRestaurants />} />
    <Route path="/admin/restaurant/:restaurantId/places" element={<RestaurantPlacesPage />} />
    <Route path="/admin/restaurant/:restaurantId/places/:placeId/tables" element={<RestaurantTablesPage />} />
<Route path="/admin/restaurant/edit/:id" element={<RestaurantEditPage />} />
<Route path="/admin/reservations-restaurants" element={<RestaurantReservationAdmin />} />
...
<Route path="/admin/events/edit/:id" element={<EventEditPage />} />
          ...
          <Route element={<AppLayoutVendeur />}>
            <Route index path="/vendeur/DashboradVendeur" element={<DashboradVendeur />} />
                      ...
                      <Route path="/vendeur/restaurants" element={<BackOfficeVendeurRestaurants />} />
    <Route path="/vendeur/ajouterestaurant" element={<AddRestaurantPage />} />


    <Route path="/vendeur/restaurant/:restaurantId/places" element={<RestaurantPlacesPage />} />
    <Route path="/vendeur/restaurant/:restaurantId/places/:placeId/tables" element={<RestaurantTablesPage />} />
...
<Route path="/vendeur/restaurant/edit/:id" element={<RestaurantEditPage />} />
    ...
    <Route path="/vendeur/ajouterevenement" element={<AddActivityPage />} />
        <Route path="/vendeur/ajouterevenementfree" element={<AddActivityPageFree />} />
                            ...
                            <Route path="/vendeur/RestaurantReservation" element={<RestaurantReservation />} />
...
<Route path="/restaurants/:id" element={<RestaurantDetailsPage />} />
    ...
    <Route path="/mot-de-passe-oublie" element={<ResetPassword />} />
           ...
           <Route path="/planningPage" element={<PlanningPage  />} />
            ...
            <Route path="/payment/failed" element={<PaymentPagefailed />} />
