...
const categoriesData = [
  ...
  },
  {
    ...
    subItems: ["Tunis", "Hammamet", "Sousse", "Djerba"],
  },
...
function Navbar() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Votre inscription a bien été enregistrée. Elle sera traitée dans les plus brefs délais par notre équipe, qui ne manquera pas de vous contacter prochainement.",
      );
      setModalOpenpartenaire(false);
    } catch (error) {
      console.error("Erreur lors de l'inscription :", error);
      const message =
        error.response?.data || "Erreur lors de la création du compte.";
      alert(message);
    }
  };
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      localStorage.setItem(
        "reservations",
        JSON.stringify(admin.reservations || []),
      );
  ...
  return (
    <>
      <AppBar
        ...
        <Toolbar
          sx={{ gap: 0, minHeight: "64px !important", px: { xs: 2, lg: 3 } }}>
          <Box
            component="a"
            href="/"
            sx={{ display: "flex", alignItems: "center", mr: 2, py: "2px" }}>
            <Box
              component="img"
              src="logo/wawwhite.png" // ⬅️ Replace with your actual image path
              alt="Logo"
              sx={{
                height: 80,
                width: "auto",
  ...
  <LanguageIcon />
              ...
              {!localStorage.getItem("userId") &&
                ...
                !localStorage.getItem("businessId") && (
                  <>
                    <ButtonNav onClick={handleOpensignin}>
                      Se connecter
                    </ButtonNav>
                    <ButtonNav onClick={handleOpenUser}>S'inscrire</ButtonNav>
                  </>
                )}
              ...
              {localStorage.getItem("adminId") && (
                <>
                  <IconButton
                    ...
                    aria-controls={
                      openProfileMenu ? "profile-menu-admin" : undefined
                    }
                    aria-haspopup="true"
                  ...
                  <Menu
                    ...
                    MenuListProps={{
                      "aria-labelledby": "profile-button-admin",
                    }}>
                    <MenuItem component={Link} to="/admin/events">
                      Dashboard Admin
                    </MenuItem>
                    <MenuItem
                      component={Link}
              ...
              {localStorage.getItem("userId") && (
                <>
                  <IconButton
                    ...
                    aria-controls={
                      openProfileMenu ? "profile-menu-user" : undefined
                    }
                    aria-haspopup="true"
                    aria-expanded={openProfileMenu ? "true" : undefined}
                    onClick={handleProfileClick}
                  ...
                  <Menu
                    ...
                    onClose={handleProfileClose}
                    MenuListProps={{
                      "aria-labelledby": "profile-button-user",
                    }}>
                    <MenuItem component={Link} to="/moncompte">
                      Mon Profil
                    </MenuItem>
                    <MenuItem component={Link} to="/mesreservations">
                      Mes Réservations
                    </MenuItem>
                    <MenuItem
                      component={Link}
              ...
              {localStorage.getItem("businessId") && (
                <>
                  <IconButton
                    ...
                    <Avatar
                      src={
                        localStorage.getItem("businessImage") ||
                        "/default-avatar.png"
                      }
                      alt="Business"
                      sx={{ width: 32, height: 32 }}
                  ...
                  <Menu
                    ...
                    <MenuItem component={Link} to="/vendeur/events">
                      Dashboard vendeur
                    </MenuItem>
                    <MenuItem
                      component={Link}
          ...
          {isMobile && (
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <Box sx={{ position: "relative" }}>
                <IconButton onClick={handleFavorites} color="inherit">
                  <FavoriteIcon />
                </IconButton>
                {count > 0 && (
                  <Box
                ...
                <Box sx={{ width: 280, pt: 2 }} role="presentation">
                  ...
                  <List>
                    ...
                    <ListItem
                      ...
                      to="/restaurants"
                      onClick={toggleDrawer(false)}>
                      <ListItemText primary="Ramadan" />
                    </ListItem>
                    <ListItem
                      button
                      onClick={() => {
                        handleOpenpartenaire();
                        toggleDrawer(false)();
                      }}>
      ...
      <Modal
        open={open}
        onClose={handleClose}
        aria-labelledby="modal-language-currency">
        <Box
          sx={{
            position: "absolute",
            top: "50%",
          ...
          <Tabs
            ...
            aria-label="Sélection onglet langue ou devise">
            <Tab label="Langue" />
            <Tab label="Devise" />
          </Tabs>
      ...
      <Modal
        isOpen={modalOpenpartenaire}
        onClose={() => setModalOpenpartenaire(false)}
        className="max-w-[700px] p-6">
        <div className="space-y-4">
          <div className="flex flex-col flex-1">
            <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                  ...
                  {step === 1 && (
                    <div className="space-y-4">
                      ...
                      {accountType === "personne" && (
                        <div>
                          <Label>
                            CIN<span className="text-error-500">*</span>
                          </Label>
                          <Input
                            type="text"
                            name="cin"
                      ...
                      {accountType === "pro" && (
                        <>
                          <div>
                            <Label>
                              RNE<span className="text-error-500">*</span>
                            </Label>
                            <Input
                              type="text"
                              name="rne"
      ...
      <Modal
        ...
        <div className="space-y-4">
          ...
          <form onSubmit={handleSubmitUser} className="space-y-4">
            ...
            {geoErrorUser && (
              <Typography color="error">{geoErrorUser}</Typography>
            )}
            <Typography variant="body2">
