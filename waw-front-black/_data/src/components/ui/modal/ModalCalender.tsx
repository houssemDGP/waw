...
useEffect(() => {
  ...
  const contentClasses = isFullscreen
    ? "w-full h-full bg-[#021732] "
    : isMobile
    ? "relative w-full max-w-lg sm:max-w-xl rounded-3xl bg-[#021732] "
    : "relative w-11/12 sm:w-3/4 md:w-2/3 lg:w-1/3 aspect-square rounded-3xl bg-[#021732] shadow-lg";
