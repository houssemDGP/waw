  ...
  >
    ...
    <Button
      ...
      sx={{
        textTransform: "none",
        fontWeight: 500,
        borderColor: inputValue ? "#181AD6" : "#e5e7eb",
        borderRadius: "20px",
        color: inputValue ? "#fff" : "#2a3944",
        backgroundColor: inputValue ? "#181AD6" : "transparent",
        "&:hover": {
          backgroundColor: inputValue ? "#181AD6" : "#181AD610",
          borderColor: "#181AD6",
          color: inputValue ? "#fff" : "#181AD6",
        },
      }}
  ...
  return (
    <Button
      ...
      sx={{
        ...
        backgroundColor: selectedHour === h ? "#181AD6" : "transparent",
        padding: "2px 8px",
        "&:hover": {
          backgroundColor: disabled ? "transparent" : "#181AD6",
          color: disabled ? "#9ca3af" : "#fff",
          borderColor: disabled ? "#e5e7eb" : "#181AD6",
        },
      }}
      onClick={() => {
        setSelectedHour(h);
...
<Box sx={{ display: 'flex', gap: 2 }}>
  <Button
    ...
    sx={{
      ...
      fontWeight: 500,
      borderColor: "#181AD6",
      color: showBestOnly ? "white" : "#181AD6",
      backgroundColor: showBestOnly ? "#181AD6" : "#f0f0f0",
      "&:hover": {
  ...
  <div >
    ...
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      <Link href={`/profile?id=${m.business.id}`} passHref>
        <span style={{ color: "#181AD6", marginTop: 4 }}>{m.business.nom}</span>
      </Link>
    </div>
  </div>
</Popup>
