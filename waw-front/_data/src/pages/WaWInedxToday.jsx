...
{/*
 <div
      ...
      >
        <IconButton aria-label="Previous" sx={{ color: "#181AD6" }} onClick={handlePrev}>
          <ArrowBackIosNewIcon />
        </IconButton>



        <IconButton aria-label="Next" sx={{ color: "#181AD6" }} onClick={handleNext}>
          <ArrowForwardIosIcon />
        </IconButton>
      </div>
...
<Typography
  variant="h5"
  sx={{ color: '#181AD6', fontWeight: 'bold', paddingTop: '60px',paddingBottom: '30px',  fontFamily: "Rock Salt"
  }}
>
