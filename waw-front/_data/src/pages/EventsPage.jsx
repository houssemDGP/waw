...
const allEvents = [
  {
    ...
    amenities: [
      { icon: <WifiIcon fontSize="small" />, text: 'WiFi' },
      { icon: <LocalDiningIcon fontSize="small" />, text: 'Restauration' },
      { icon: <PoolIcon fontSize="small" />, text: 'Piscine' },
    ],
  },
  {
    id: 2,
    ...
    amenities: [{ icon: <LocalDiningIcon fontSize="small" />, text: 'Snacks' }],
  },
  {
    id: 3,
    ...
    amenities: [{ icon: <WifiIcon fontSize="small" />, text: 'WiFi' }],
  },
  {
    id: 4,
